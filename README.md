...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/entsoe-py-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=7273&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/entsoe-py-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `entsoe-py` can be installed with:

```
conda install entsoe-py
```

It is possible to list all of the versions of `entsoe-py` available on your platform with:
